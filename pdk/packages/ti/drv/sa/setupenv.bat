...
@REM * Copyright (C) 2010-2013, Texas Instruments, Inc.
@REM *****************************************************************************
...
set PDK_INSTALL_PATH=C:\ti\pdk_keystone2_3_01_00_01\packages
:pdk_defined
...
@REM ---------------------------------
@REM Enabling LINUX user mode to be Built
@REM ---------------------------------
set BUILD_LINUX=OFF
@echo Linux build is set to %BUILD_LINUX%
...
set PATH=%PATH%;T:\gen\InstallJammer\v1_2_15
...
Title SA LLD Build Environment
