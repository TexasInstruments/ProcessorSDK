...
SRCS_COMMON += vhwa_examples_common.c vhwa_dof_api.c vhwa_common_crc.c ldra_vhwa_coverage_main.c
...
ifeq ($(vhwa_dof_testapp_freertos_SBL_APPIMAGEGEN),yes)
vhwa_dof_testapp_freertos_MAKEFILE = -f makefile BUILD_OS_TYPE=freertos sbl_appimagegen
endif
ifeq ($(vhwa_dof_testapp_safertos_SBL_APPIMAGEGEN),yes)
vhwa_dof_testapp_safertos_MAKEFILE = -f makefile BUILD_OS_TYPE=safertos sbl_appimagegen
endif
ifeq ($(vhwa_dof_baremetal_testapp_SBL_APPIMAGEGEN),yes)
vhwa_dof_baremetal_testapp_MAKEFILE = -f makefile BUILD_OS_TYPE=baremetal sbl_appimagegen
endif
