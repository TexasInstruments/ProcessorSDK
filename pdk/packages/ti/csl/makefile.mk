...
ifeq ($(SOC),$(filter $(SOC), $(DEFAULT_SOCLIST_safertos)))
PACKAGE_SRCS_COMMON += ../build/safertos_package_path.mk ../build/safertos_setup.sh ../build/safertos_version.mk
endif
...
PACKAGE_SRCS_COMMON += config_mk.bld cslver.h cslver.h.xdt package.bld package.xdc package.xs Settings.xdc.xdt
...
#Set compiler flag to enable readback
ifeq ($(RB_ENABLE), true)
  CFLAGS_LOCAL_COMMON += -DSM_READBACK_ENABLED
endif
...
-include src/ip/cbuff/src_files_cbuff.mk
-include src/ip/cgem/src_files_cgem.mk
-include src/ip/chr_us/src_files_chr_us.mk
-include src/ip/cpdma/src_files_cpdma.mk
...
-include src/ip/hwa/src_files_hwa.mk
...
-include src/ip/eqep/src_files_eqep.mk
...
-include src/ip/sa/src_files_sa.mk
...
-include src/ip/bcdma/src_files_bcdma.mk
-include src/ip/pktdma/src_files_pktdma.mk
-include src/ip/lcdma_ringacc/src_files_lcdma_ringacc.mk
-include src/ip/pok/src_files_pok.mk
-include src/ip/compute_cluster/src_files_compute_cluster.mk
-include src/ip/spi/src_files_spi.mk
-include src/ip/dthe/src_files_dthe.mk
-include src/ip/sha/src_files_sha.mk
-include src/ip/pmmc/src_files_pmmc.mk
