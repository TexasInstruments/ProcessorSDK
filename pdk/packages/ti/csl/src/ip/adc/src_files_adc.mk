ifeq ($(SOC),$(filter $(SOC), tda3xx dra78x am65xx j7200 j721e j721s2 j784s4 j742s2 am64x am62lx))
...
ifeq ($(SOC),$(filter $(SOC), am65xx j7200 j721e j721s2 j784s4 j742s2 am64x am62lx))
