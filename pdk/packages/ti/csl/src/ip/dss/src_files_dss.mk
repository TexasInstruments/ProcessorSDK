...
ifeq ($(SOC),$(filter $(SOC), tda2xx tda2px am572x am574x dra75x tda2ex dra72x am571x tda3xx dra78x am65xx j7200 j721e j721s2 j784s4 j742s2 am62x am62px))
...
ifeq ($(SOC),$(filter $(SOC), am65xx am62x am62px))
...
PACKAGE_SRCS_COMMON += src/ip/dss/V5
PACKAGE_SRCS_COMMON += csl_fvid2_dataTypes.h
INCDIR += src/ip/dss/V5
endif
