@REM ******************************************************************************
@REM * FILE PURPOSE: Environment Setup for building CSL
@REM ******************************************************************************
@REM * FILE NAME: setupenv.bat
@REM *
@REM * DESCRIPTION: 
@REM *  Configures and sets up the Build Environment for CSL
@REM *
@REM * Copyright (C) 2011, Texas Instruments, Inc.
@REM *****************************************************************************

@echo ---------------------------------
@echo Configuring CSL Build Environment
@echo off

@REM Set the Part Number.
...
REM set C6X_GEN_INSTALL_PATH=T:\c6xx\cgen7_4_02\c6000\cgtools

@REM Specify the XDC Tool Path
REM set XDC_INSTALL_PATH=C:/Progra~2/TexasI~1/xdctools_3_25_02_70
REM set XDC_INSTALL_PATH=e:/ti3/xdctools_3_25_02_70
set XDCPATH=../../..;%XDC_INSTALL_PATH%/packages

@REM Configure the XDCPATH
set XDCPATH=%XDCPATH%;%C6X_GEN_INSTALL_PATH%/include
...
Title CSL Build Environment

@echo CSL Build Environment Configured 
@echo ---------------------------------
