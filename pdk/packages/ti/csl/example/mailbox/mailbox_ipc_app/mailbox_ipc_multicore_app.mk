#
# This file is the makefile for making a combined app image of mailbox_ipc_app for all the cores
#
include $(PDK_INSTALL_PATH)/ti/build/Rules.make

APP_NAME = csl_mailbox_ipc_multicore_app

SRCDIR += $(PDK_IPC_COMP_PATH)/examples/mailbox_ipc_app

# Local name of mailbox ipc app
RPRC_PREFIX = csl_mailbox_ipc_app

MULTICORE_IMG_PARAMS = $(foreach SOC_CORE_ID, $(csl_mailbox_ipc_app_$(SOC)_CORELIST), $(SBL_CORE_ID_$(SOC_CORE_ID)) $(BINDIR)/$(RPRC_PREFIX)_$(SOC_CORE_ID)_$(BUILD_PROFILE_$(CORE)).rprc)
...
$(BINDIR)/$(RPRC_PREFIX)_all_cores_$(BUILD_PROFILE_$(CORE)).appimage.signed:
	$(ECHO) "# Combining RPRC images to generate multicore image...."
	$(ECHO) "# BINDIR is $(BINDIR) CORELIST is $(csl_mailbox_ipc_app_$(SOC)_CORELIST)"
	...
	$(ECHO) "#"
	$(ECHO) "# Multicore App image $(BINDIR)/$(RPRC_PREFIX)_all_cores_$(BUILD_PROFILE_$(CORE)).appimage created."
	$(ECHO) "#"
