...
const includes_freertos_r5f = {
    common: [
	    ...
	    "${MCU_PLUS_SDK_PATH}/source/networking/enet/utils/V2/am263x",
...
const libs_freertos_r5f = {
    common: [
        ...
        "enet-lwip-cpsw.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-freertos.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
        "board.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-contrib.am263x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
[
    ...
    {
        input: ".project/templates/am263x/enet/board_enet.c.xdt",
        output: "../board.c",
    }
];
