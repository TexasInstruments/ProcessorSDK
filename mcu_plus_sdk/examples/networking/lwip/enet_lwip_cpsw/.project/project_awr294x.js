...
const includes_freertos_r5f = {
    common: [
		...
		"${MCU_PLUS_SDK_PATH}/source/networking/enet/utils/V2/awr294x",
        ...
        "${MCU_PLUS_SDK_PATH}/source/networking/enet/hw_include/mdio/V5",
...
const libs_freertos_r5f = {
    common: [
        ...
        "enet-lwip-cpsw.awr294x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-freertos.awr294x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-contrib.awr294x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
[
    ...
    {
        input: ".project/templates/awr294x/enet/board_enet.c.xdt",
        output: "../board.c",
    }
];
