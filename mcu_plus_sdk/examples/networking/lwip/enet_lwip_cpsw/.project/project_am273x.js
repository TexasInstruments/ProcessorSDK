...
const includes_freertos_r5f = {
    common: [
	    ...
	    "${MCU_PLUS_SDK_PATH}/source/networking/enet/utils/V2/am273x",
...
const libs_freertos_r5f = {
    common: [
        ...
        "enet-lwip-cpsw.am273x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-freertos.am273x.r5f.ti-arm-clang.${ConfigName}.lib",
        "lwip-contrib.am273x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
[
    ...
    {
        input: ".project/templates/am273x/enet/board_enet.c.xdt",
        output: "../board.c",
    }
];
