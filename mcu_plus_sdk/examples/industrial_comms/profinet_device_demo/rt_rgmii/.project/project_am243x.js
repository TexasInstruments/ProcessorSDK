...
const libs_freertos_r5f_evm = {
    common: [
        ...
        "profinet_device_rt_mrp_rgmii_icss_fwhal.am243x.r5f.ti-arm-clang.${ConfigName}.lib",
        "profinetiodevice_rgmii.am243x-evm.r5f.ti-arm-clang.release.lib",
    ],
};
...
const libs_freertos_r5f_lp = {
    common: [
        ...
        "icss_emac.am243x.r5f.ti-arm-clang.${ConfigName}.lib",
        "profinet_device_rt_mrp_rgmii_icss_fwhal.am243x.r5f.ti-arm-clang.${ConfigName}.lib",
        "profinetiodevice_rgmii.am243x-lp.r5f.ti-arm-clang.release.lib",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "profinet_device_rt_rgmii_demo";
