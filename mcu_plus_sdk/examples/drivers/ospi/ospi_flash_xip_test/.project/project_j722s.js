...
const readmeDoxygenPageTag = "EXAMPLES_OSPI_FLASH_XIP_TEST";
...
[
    ...
    },
	{
		...
		output: "../main.c",
		options: {
			entryFunction: "ospi_flash_xip_test_main",
		},
	}
];
...
function getComponentProperty() {
    ...
    property.name = "ospi_flash_xip_test";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "OSPI Flash XIP test"
