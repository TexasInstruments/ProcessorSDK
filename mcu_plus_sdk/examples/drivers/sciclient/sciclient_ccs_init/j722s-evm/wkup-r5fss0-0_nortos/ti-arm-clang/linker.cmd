...
SECTIONS
{
    ...
    .startupData: {} palign(8) > MSRAM, type = NOINIT
    ...
    .text            : {} palign(8)      > MSRAM
    .const           : {} palign(8)      > MSRAM
    .rodata          : {} palign(8)      > MSRAM
    .cinit           : {} palign(8)      > MSRAM
    .far             : {} align(4)       > MSRAM
    .data            : {} palign(128)    > MSRAM
    .data_buffer     : {} palign(128)    > MSRAM
    .const.devgroup  : { *(.const.devgroup*) } align(4) > MSRAM
    .boardcfg_data   : {} align(4)       > MSRAM
...
MEMORY
{
    ...
    /* Use MSRAM before DDR has been initialized */
    MSRAM       : ORIGIN = 0x70000040 LENGTH = 0x3F000
