...
let EPWM_DiodeEmulationMode= [
    {name: "EPWM_DIODE_EMULATION_CBC", displayName: "CBC MODE"},
    {name: "EPWM_DIODE_EMULATION_OST", displayName: "OST MODE"}
]

let EPWM_DiodeEmulationTripSource= [

    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT0", displayName: "Sync in source is Input XBAR out0 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT1", displayName: "Sync in source is Input XBAR out1 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT2", displayName: "Sync in source is Input XBAR out2 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT3", displayName: "Sync in source is Input XBAR out3 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT4", displayName: "Sync in source is Input XBAR out4 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT5", displayName: "Sync in source is Input XBAR out5 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT6", displayName: "Sync in source is Input XBAR out6 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT7", displayName: "Sync in source is Input XBAR out7 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT8", displayName: "Sync in source is Input XBAR out8 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT9", displayName: "Sync in source is Input XBAR out9 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT10", displayName: "Sync in source is Input XBAR out10 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT11", displayName: "Sync in source is Input XBAR out11 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT12", displayName: "Sync in source is Input XBAR out12 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT13", displayName: "Sync in source is Input XBAR out13 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT14", displayName: "Sync in source is Input XBAR out14 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT15", displayName: "Sync in source is Input XBAR out15 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT16", displayName: "Sync in source is Input XBAR out16 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT17", displayName: "Sync in source is Input XBAR out17 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT18", displayName: "Sync in source is Input XBAR out18 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT19", displayName: "Sync in source is Input XBAR out19 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT20", displayName: "Sync in source is Input XBAR out20 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT21", displayName: "Sync in source is Input XBAR out21 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT22", displayName: "Sync in source is Input XBAR out22 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT23", displayName: "Sync in source is Input XBAR out23 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT24", displayName: "Sync in source is Input XBAR out24 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT25", displayName: "Sync in source is Input XBAR out25 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT26", displayName: "Sync in source is Input XBAR out26 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT27", displayName: "Sync in source is Input XBAR out27 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT28", displayName: "Sync in source is Input XBAR out28 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT29", displayName: "Sync in source is Input XBAR out29 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT30", displayName: "Sync in source is Input XBAR out30 signal"},
    {name: "EPWM_DE_TRIP_SRC_INPUTXBAR_OUT31", displayName: "Sync in source is Input XBAR out31 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA0", displayName: "Sync in source is CMPSSA0 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA1", displayName: "Sync in source is CMPSSA1 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA2", displayName: "Sync in source is CMPSSA2 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA3", displayName: "Sync in source is CMPSSA3 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA4", displayName: "Sync in source is CMPSSA4 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA5", displayName: "Sync in source is CMPSSA5 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA6", displayName: "Sync in source is CMPSSA6 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA7", displayName: "Sync in source is CMPSSA7 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA8", displayName: "Sync in source is CMPSSA8 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSA9", displayName: "Sync in source is CMPSSA9 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB0", displayName: "Sync in source is CMPSSB0 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB1", displayName: "Sync in source is CMPSSB1 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB2", displayName: "Sync in source is CMPSSB2 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB3", displayName: "Sync in source is CMPSSB3 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB4", displayName: "Sync in source is CMPSSB4 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB5", displayName: "Sync in source is CMPSSB5 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB6", displayName: "Sync in source is CMPSSB6 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB7", displayName: "Sync in source is CMPSSB7 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB8", displayName: "Sync in source is CMPSSB8 signal"},
    {name: "EPWM_DE_TRIP_SRC_CMPSSB9", displayName: "Sync in source is CMPSSB9 signal"},
]
