#
# This file is common makefile for building VHWA MSC test app for both TI-RTOS/baremetal
#
SRCDIR = .
SRCDIR += ../common
INCDIR =
...
SRCS_COMMON += vhwa_examples_common.c vhwa_msc_api.c vhwa_common_crc.c ldra_vhwa_coverage_main.c
...
ifeq ($(vhwa_msc_testapp_freertos_SBL_APPIMAGEGEN),yes)
vhwa_msc_testapp_freertos_MAKEFILE = -f makefile BUILD_OS_TYPE=freertos sbl_appimagegen
endif
ifeq ($(vhwa_msc_testapp_safertos_SBL_APPIMAGEGEN),yes)
vhwa_msc_testapp_safertos_MAKEFILE = -f makefile BUILD_OS_TYPE=safertos sbl_appimagegen
endif
ifeq ($(vhwa_msc_baremetal_testapp_SBL_APPIMAGEGEN),yes)
vhwa_msc_baremetal_testapp_MAKEFILE = -f makefile BUILD_OS_TYPE=baremetal sbl_appimagegen
endif
