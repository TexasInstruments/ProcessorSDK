    /* 0 : SDE 2048x1024 test  SR 192*/
    {
        ...
        0xb4ac8761,
        {0, 0, 0},
        VHWA_WDTIMEOUT_64K_CYCLES, VHWA_WDTIMEOUT_64K_CYCLES, VHWA_SDE_ALL_WDTIMER_ERR_EVENTS
    },
    ...
    /* 18 : SDE 1280x720 test SR 192 Texture Filter Disabled*/
    {
        FVID2_CCSF_BITS8_PACKED,
        1280, 1280,
        (1280 * 2),
    ...
    /* 19 : SDE 1280x720 test SR 192 Median Filter disabled*/
    {
        FVID2_CCSF_BITS8_PACKED,
        1280, 1280,
        (1280 * 2),
    ...
    /* 20 : SDE 1280x720 test SR 192 LR disabled*/
    {
        FVID2_CCSF_BITS8_PACKED,
        1280, 1280,
        (1280 * 2),
    ...
    /* 22 : SDE 128x64 test  SR 64*/
    /*test case for sdePrms -> sdeCfg.width < ( 128U ) sdePrms -> sdeCfg.height < ( 64U ) false condition in Vhwa_sdeCheckCfg()*/
    {
        FVID2_CCSF_BITS12_PACKED,
        192, 192,
        (128 * 2),
        1, 1, 64, 32, 0, (uint32_t)SDE_SR_64,
        0x3D, 1, 0x18, 0x9, 0x26, 1, 1,
        UFALSE, 0x0, /* CRC */
    },
    
    /* 23 : SDE 128x64 test  SR 64*/
    /*test case for sdePrms -> sdeCfg.width > ( 2048U ) )sdeCfg.height > ( 1024U ) )   || false condition in Vhwa_sdeCheckCfg()*/
    {
        FVID2_CCSF_BITS12_PACKED,
        192, 192,
        (128 * 2),
        1, 1, 2049, 1025, 0, (uint32_t)SDE_SR_64,
        0x3D, 1, 0x18, 0x9, 0x26, 1, 1,
        UFALSE, 0x0, /* CRC */
    },
    
    /* 24 : SDE 128x64 test  SR 64*/
    /*test case for > sdeCfg.width & 0xFu ) != 0u ) ||  || false condition in Vhwa_sdeCheckCfg()*/
    {
        FVID2_CCSF_BITS12_PACKED,
        192, 192,
        (128 * 2),
        1, 1, 0, 0, 64, (uint32_t)SDE_SR_64,
        0x3D, 1, 0x18, 0x9, 0x26, 1, 1,
        UFALSE, 0x0, /* CRC */
    },
