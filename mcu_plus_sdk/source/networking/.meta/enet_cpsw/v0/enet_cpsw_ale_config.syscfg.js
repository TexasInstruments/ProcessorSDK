    ...
    config: [
        {
            ...
            onChange: function (inst, ui) {
                if(inst.aleVlanAwareMode === true) {
                    hideGroup(getGroupHierarchyByName(inst.$module.config, "aleConfig/aleVlanConfig/unknownVlanCfg"), false, ui);
                }
                else {
                    hideGroup(getGroupHierarchyByName(inst.$module.config, "aleConfig/aleVlanConfig/unknownVlanCfg"), true, ui);
                }
            },
        },
        {
            ...
            onChange: function (inst, ui) {
                ...
                if(inst.cpswVlanAwareMode == false) {
                    hideGroup(getGroupHierarchyByName(inst.$module.config, "aleConfig/alePortConfig/pvidCfg"), true, ui);
                }
                else {
                    hideGroup(getGroupHierarchyByName(inst.$module.config, "aleConfig/alePortConfig/pvidCfg"), false, ui);
                }
            },
        },
        {
    ...
    config: [
        {
            ...
            onChange: function (inst, ui) {
                ...
                if(inst.authModeEn == false) {
                    hideGroup(getGroupHierarchyByName(inst.$module.config, "aleConfig/aleNetworkSecurityConfig/macAuthCfg/macAuthPortDisable"), true, ui);
                }
                else {
                    hideGroup(getGroupHierarchyByName(inst.$module.config, "aleConfig/aleNetworkSecurityConfig/macAuthCfg/macAuthPortDisable"), false, ui);
                }
            },
        },
        {
...
function updatePortVlanConfig(updatedConfig, fromProperty, toProperty) {

    for (var member in updatedConfig)
    {
        if (typeof updatedConfig[member] == "object" && updatedConfig[member] !== null)
        {
            updatePortVlanConfig(updatedConfig[member], fromProperty, toProperty);
        }
        else
        {
...
function getPortSpecificConfig(configObj, fromProperty, toProperty) {
    ...
    updatedConfig = updatePortVlanConfig(updatedConfig, fromProperty,toProperty);
    return updatedConfig;
}
...
const enet_cpsw_port_learning_security_config = {
    ...
    longDescription: "Port specific auto learning security configuration",
    config: [
        getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "hostPort"),
        getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort1"),
        getPortSpecificConfig(enet_cpsw_port_learning_security_config_common, "#", "macPort2"),
    ],
};
...
const enet_cpsw_port_vlan_security_config = {
    ...
    longDescription: "Port specific VLAN security configuration",
    config: [
        getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "hostPort"),
        getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort1"),
        getPortSpecificConfig(enet_cpsw_port_vlan_security_config_common, "#", "macPort2"),
    ],
};
...
const enet_cpsw_port_mac_mode_config = {
    ...
    longDescription: "Port specific mac only mode configuration",
    config: [
        getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "hostPort"),
        getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort1"),
        getPortSpecificConfig(enet_cpsw_port_mac_mode_config_common, "#", "macPort2"),
    ],
};
...
const enet_cpsw_port_vlan_config = {
    ...
    hidden:true,
    config: [
        getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "hostPort"),
        getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort1"),
        getPortSpecificConfig(enet_cpsw_port_vlan_config_common, "#", "macPort2"),
    ],
};
