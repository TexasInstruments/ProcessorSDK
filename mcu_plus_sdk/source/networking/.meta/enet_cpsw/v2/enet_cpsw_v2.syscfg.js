...
function getNumCpdmaDesc(instance) {
    const desc2PacketScalingFactor = 2;
    let cpdmaNumDesc = getRxPacketsCount(instance) + getTxPacketsCount(instance);
    
    cpdmaNumDesc *= desc2PacketScalingFactor;
    return  cpdmaNumDesc;
}
