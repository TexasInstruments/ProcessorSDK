...
const files = {
    common: [
        ...
        "cpsw_macport_est_ioctl_register.c",
        "cpsw_hostport.c",
...
const filedirs = {
    common: [
       ...
       "${MCU_PLUS_SDK_PATH}/source/networking/enet/core/lwipif/src/V2",
    ],
};
...
const includes = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/networking/enet/core/src/phy",
        "${MCU_PLUS_SDK_PATH}/source/networking/enet/core/hw_include",
