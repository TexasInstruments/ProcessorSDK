...
const filedirs = {
    common: [
       ...
       // FreRTOS lwip port
       "${MCU_PLUS_SDK_PATH}/source/networking/lwip/lwip-port/freertos",
...
const includes = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/industrial_comms/profinet_device/stack/lwip/lwip-config/am243x",
...
function getComponentProperty() {
    ...
    property.name = "profinetiodevice-lwip-freertos";
    property.tag = "stack";
