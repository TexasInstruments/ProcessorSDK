...
const uint32_t TableStruct_object_5fdetection_2fprotos_2fmean_5fstddev_5fbox_5fcoder_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::MeanStddevBoxCoder, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::MeanStddevBoxCoder, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::MeanStddevBoxCoder, _impl_.stddev_),
  0,
};
...
class MeanStddevBoxCoder::_Internal {
 public:
  using HasBits = decltype(std::declval<MeanStddevBoxCoder>()._impl_._has_bits_);
...
MeanStddevBoxCoder::MeanStddevBoxCoder(const MeanStddevBoxCoder& from)
  ...
  MeanStddevBoxCoder* const _this = this; (void)_this;
  new (&_impl_) Impl_{
...
void MeanStddevBoxCoder::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MeanStddevBoxCoder*>(&to_msg);
  auto& from = static_cast<const MeanStddevBoxCoder&>(from_msg);
  ...
  if (from._internal_has_stddev()) {
    _this->_internal_set_stddev(from._internal_stddev());
  }
