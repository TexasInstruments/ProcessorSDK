...
class GraphRewriter final :
 ...
 public:
  ...
  void MergeFrom( const GraphRewriter& from) {
    GraphRewriter::MergeImpl(*this, from);
  }
  private:
...
class Quantization final :
 ...
 public:
  ...
  void MergeFrom( const Quantization& from) {
    Quantization::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline const ::object_detection::protos::Quantization& GraphRewriter::_internal_quantization() const {
  const ::object_detection::protos::Quantization* p = _impl_.quantization_;
...
inline void GraphRewriter::unsafe_arena_set_allocated_quantization(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.quantization_);
  }
  _impl_.quantization_ = quantization;
  if (quantization) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
...
inline ::object_detection::protos::Quantization* GraphRewriter::release_quantization() {
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::object_detection::protos::Quantization* temp = _impl_.quantization_;
...
inline int32_t Quantization::_internal_activation_bits() const {
  return _impl_.activation_bits_;
}
