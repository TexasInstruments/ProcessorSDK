...
class DetectionModel final :
 ...
 public:
  ...
  void MergeFrom( const DetectionModel& from) {
    DetectionModel::MergeImpl(*this, from);
  }
  private:
...
inline void DetectionModel::set_has_faster_rcnn() {
  _impl_._oneof_case_[0] = kFasterRcnn;
}
inline ::object_detection::protos::FasterRcnn* DetectionModel::release_faster_rcnn() {
  ...
  if (_internal_has_faster_rcnn()) {
    clear_has_model();
    ::object_detection::protos::FasterRcnn* temp = _impl_.model_.faster_rcnn_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.model_.faster_rcnn_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::object_detection::protos::FasterRcnn* DetectionModel::_internal_mutable_faster_rcnn() {
  if (!_internal_has_faster_rcnn()) {
    clear_model();
    set_has_faster_rcnn();
    _impl_.model_.faster_rcnn_ = CreateMaybeMessage< ::object_detection::protos::FasterRcnn >(GetArenaForAllocation());
  }
  return _impl_.model_.faster_rcnn_;
}
...
inline ::object_detection::protos::Ssd* DetectionModel::release_ssd() {
  ...
  if (_internal_has_ssd()) {
    clear_has_model();
    ::object_detection::protos::Ssd* temp = _impl_.model_.ssd_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.model_.ssd_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::object_detection::protos::Ssd* DetectionModel::_internal_mutable_ssd() {
  if (!_internal_has_ssd()) {
    clear_model();
    set_has_ssd();
    _impl_.model_.ssd_ = CreateMaybeMessage< ::object_detection::protos::Ssd >(GetArenaForAllocation());
  }
  return _impl_.model_.ssd_;
}
...
inline DetectionModel::ModelCase DetectionModel::model_case() const {
  return DetectionModel::ModelCase(_impl_._oneof_case_[0]);
}
#ifdef __GNUC__
