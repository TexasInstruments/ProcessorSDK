...
const uint32_t TableStruct_object_5fdetection_2fprotos_2ffaster_5frcnn_5fbox_5fcoder_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::FasterRcnnBoxCoder, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::FasterRcnnBoxCoder, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::FasterRcnnBoxCoder, _impl_.y_scale_),
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::FasterRcnnBoxCoder, _impl_.x_scale_),
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::FasterRcnnBoxCoder, _impl_.height_scale_),
  PROTOBUF_FIELD_OFFSET(::object_detection::protos::FasterRcnnBoxCoder, _impl_.width_scale_),
  0,
  1,
  2,
  3,
...
class FasterRcnnBoxCoder::_Internal {
 public:
  using HasBits = decltype(std::declval<FasterRcnnBoxCoder>()._impl_._has_bits_);
...
FasterRcnnBoxCoder::FasterRcnnBoxCoder(const FasterRcnnBoxCoder& from)
  ...
  FasterRcnnBoxCoder* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  ::memcpy(&_impl_.y_scale_, &from._impl_.y_scale_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.width_scale_) -
    reinterpret_cast<char*>(&_impl_.y_scale_)) + sizeof(_impl_.width_scale_));
...
void FasterRcnnBoxCoder::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<FasterRcnnBoxCoder*>(&to_msg);
  auto& from = static_cast<const FasterRcnnBoxCoder&>(from_msg);
