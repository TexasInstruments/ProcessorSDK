...
class GridAnchorGenerator final :
 ...
 public:
  ...
  void MergeFrom( const GridAnchorGenerator& from) {
    GridAnchorGenerator::MergeImpl(*this, from);
  }
  private:
