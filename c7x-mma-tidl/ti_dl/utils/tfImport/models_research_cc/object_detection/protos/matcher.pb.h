...
inline void Matcher::set_has_argmax_matcher() {
  _impl_._oneof_case_[0] = kArgmaxMatcher;
}
inline ::object_detection::protos::ArgMaxMatcher* Matcher::release_argmax_matcher() {
  ...
  if (_internal_has_argmax_matcher()) {
    ...
    ::object_detection::protos::ArgMaxMatcher* temp = _impl_.matcher_oneof_.argmax_matcher_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.matcher_oneof_.argmax_matcher_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::object_detection::protos::ArgMaxMatcher* Matcher::_internal_mutable_argmax_matcher() {
  if (!_internal_has_argmax_matcher()) {
    clear_matcher_oneof();
    set_has_argmax_matcher();
    _impl_.matcher_oneof_.argmax_matcher_ = CreateMaybeMessage< ::object_detection::protos::ArgMaxMatcher >(GetArenaForAllocation());
  }
  return _impl_.matcher_oneof_.argmax_matcher_;
}
...
inline void Matcher::set_has_bipartite_matcher() {
  _impl_._oneof_case_[0] = kBipartiteMatcher;
}
inline ::object_detection::protos::BipartiteMatcher* Matcher::release_bipartite_matcher() {
  ...
  if (_internal_has_bipartite_matcher()) {
    clear_has_matcher_oneof();
    ::object_detection::protos::BipartiteMatcher* temp = _impl_.matcher_oneof_.bipartite_matcher_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.matcher_oneof_.bipartite_matcher_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::object_detection::protos::BipartiteMatcher* Matcher::_internal_mutable_bipartite_matcher() {
  if (!_internal_has_bipartite_matcher()) {
    clear_matcher_oneof();
    set_has_bipartite_matcher();
    _impl_.matcher_oneof_.bipartite_matcher_ = CreateMaybeMessage< ::object_detection::protos::BipartiteMatcher >(GetArenaForAllocation());
  }
  return _impl_.matcher_oneof_.bipartite_matcher_;
}
...
inline Matcher::MatcherOneofCase Matcher::matcher_oneof_case() const {
  return Matcher::MatcherOneofCase(_impl_._oneof_case_[0]);
}
#ifdef __GNUC__
