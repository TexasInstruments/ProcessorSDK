...
const uint32_t TableStruct_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tensorflow::ResourceHandle, _impl_.device_),
  PROTOBUF_FIELD_OFFSET(::tensorflow::ResourceHandle, _impl_.container_),
  PROTOBUF_FIELD_OFFSET(::tensorflow::ResourceHandle, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::tensorflow::ResourceHandle, _impl_.hash_code_),
  PROTOBUF_FIELD_OFFSET(::tensorflow::ResourceHandle, _impl_.maybe_type_name_),
};
