...
CostGraphDef_Node::CostGraphDef_Node(const CostGraphDef_Node& from)
  ...
  ::memcpy(&_impl_.id_, &from._impl_.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.compute_cost_) -
    reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.compute_cost_));
...
// @@protoc_insertion_point(message_clear_start:tensorflow.CostGraphDef.Node)
  ...
  ::memset(&_impl_.id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.compute_cost_) -
      reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.compute_cost_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void CostGraphDef_Node::InternalSwap(CostGraphDef_Node* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CostGraphDef_Node, _impl_.compute_cost_)
      + sizeof(CostGraphDef_Node::_impl_.compute_cost_)
      - PROTOBUF_FIELD_OFFSET(CostGraphDef_Node, _impl_.id_)>(
