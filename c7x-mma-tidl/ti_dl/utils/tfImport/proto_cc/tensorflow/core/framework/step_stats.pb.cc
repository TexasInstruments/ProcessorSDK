...
AllocatorMemoryUsed::AllocatorMemoryUsed(const AllocatorMemoryUsed& from)
  ...
  ::memcpy(&_impl_.total_bytes_, &from._impl_.total_bytes_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.peak_bytes_) -
    reinterpret_cast<char*>(&_impl_.total_bytes_)) + sizeof(_impl_.peak_bytes_));
...
// @@protoc_insertion_point(message_clear_start:tensorflow.AllocatorMemoryUsed)
  ...
  ::memset(&_impl_.total_bytes_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.peak_bytes_) -
      reinterpret_cast<char*>(&_impl_.total_bytes_)) + sizeof(_impl_.peak_bytes_));
...
void AllocatorMemoryUsed::InternalSwap(AllocatorMemoryUsed* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(AllocatorMemoryUsed, _impl_.peak_bytes_)
      + sizeof(AllocatorMemoryUsed::_impl_.peak_bytes_)
...
void NodeExecStats::InternalSwap(NodeExecStats* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(NodeExecStats, _impl_.all_start_micros_)>(
          reinterpret_cast<char*>(&_impl_.all_start_micros_),
          reinterpret_cast<char*>(&other->_impl_.all_start_micros_));
}
